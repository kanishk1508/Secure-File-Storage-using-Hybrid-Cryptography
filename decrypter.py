...
def Algo1(key):
    ...
    secret_data = b""  # Initialize as byte string
    for line in target_file:
        secret_data += line  # Concatenate byte strings directly
    target_file.close()
...
def Algo1_extented(filename, key1, key2):
    ...
    raw = b""  # Initialize as byte string
    for line in file:
        raw += line  # Concatenate byte strings directly
